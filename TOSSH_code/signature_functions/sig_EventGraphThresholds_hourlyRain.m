function [IE_effect, SE_effect, IE_thresh_signif, IE_thresh, ...
    ...
    error_flag, error_str, fig_handles] = sig_EventGraphThresholds(Q,t,P,P_hrfrac,varargin)
...
for i = 1:size(stormarray,1)
    ...
    % event_array(i,3) = max(P(stormarray(i,1):stormarray(i,3)));    %Adapted to get max hourly precipitation
